...
/**
 * 自动换行的容器
 * Created by lufei on 6/4/16.
 */
public class FAutoWrappedViewGroup extends ViewGroup {

    int horizontalSpace = 0;
    int verticalSpace = 0;

    public FAutoWrappedViewGroup(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        //
    }

    public FAutoWrappedViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FAutoWrappedViewGroup(Context context) {
        this(context, null);
    }
